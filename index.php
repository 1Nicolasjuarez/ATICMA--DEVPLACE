          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets//img/patagonia.png" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">PEUGEOT PARTNER PATAGÓNICA</h5>
                  <p class="card-text">ENTREGA INMEDIATA
                    DESDE $2.552.000.</p>
                </div>
                <div class="card-footer">
                  <a href="https://belchamp.com.ar/vehiculos_0km/peugeot-partner-patagonica/" class="btn btn-secondary">+info</a>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets/img/208.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets/img/expert.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets/img/408.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets/img/suv2008.png" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title"> PEUGEOT SUV 2008</h5>
                  <p class="card-text">ENTREGA INMEDIATA DESDE $2.552.00.</p>
                </div>
                <div class="card-footer">
                  <a href="https://belchamp.com.ar/vehiculos_0km/2008/" class="btn btn-secondary">+info</a>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                <img src="./assets/img/boxer.png" class="card-img-top" alt="...">
                <div class="card-body">
